package com.wdtx.littlebell.view;
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            switch (attr)
            {
                ...
                case R.styleable.ChangeColorIconWithText_color:
                    ...
                    break;
                case R.styleable.ChangeColorIconWithText_title:
...
//                    break;
//                case R.styleable.ChangeColorIconWithText_textSize:
//                    float devValue = TypedValue.applyDimension(
//                            TypedValue.COMPLEX_UNIT_SP, 12,
//                            getResources().getDisplayMetrics());
//                    mTextSize = (int) a.getDimension(attr, devValue);
//                    break;
//            }
//        }
//
...
//        mTextPaint.setTextSize(mTextSize);
//        mTextPaint.setColor(0xff555555);
//        mTextPaint.getTextBounds(mTitle, 0, mTextSize, mTextBound);
//    }
//
//    @Override
//    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
//        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
//        int iconWidth = Math.min(
...
//
//        mIconRect = new Rect(left, top, iconWidth + left, iconWidth + top);
//    }
//
//    @Override
//    protected void onDraw(Canvas canvas) {
